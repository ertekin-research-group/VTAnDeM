...
# 1) Revising (in progress) the defects diagram plotting capability.
# 2) Fixed defect labeling (still overlaps however).
...
class Quaternary_ApplicationWindow(QMainWindow):
	...
	def __init__(self, parent = None, main_compound = None, first_species = None, second_species = None, third_species = None, fourth_species = None):	# User specifies the main compound and its constituents
		...
		self.def_carriers = []
		#self.Calculate_Defect_Concentration()
	...
	def Activate_Generate_PhaseDiagram_Plot_Button(self):
		...
		self.generate_quaternary_plot_button_label = QLabel("Hello. Welcome to [insert name of app].")	# A heart-warming welcome message that is only visible at the start of the app
	...
	def Activate_Generate_CarrierConcentration_Plot_Tools(self):
		...
		#self.Equilibrium_Fermi_Energy_display_layout.addWidget(self.Equilibrium_Fermi_Energy_display_widget)
	...
	def Calculate_Total_Charge_Density(self, ef, T):
		...
		#print(self.list_carriers)
		tot_charge_density=sum(self.list_carriers)
		#print(tot_charge_density)
	...
	def Calculate_Equilibrium_Fermi_Energy(self, T):
		...
		for cdindex in np.arange(0,len(list_tot_charge_density)-1):
			...
			#else:
				#print('1')
				#print(np.sign(list_tot_charge_density[cdindex]))
				#print(list_tot_charge_density[cdindex])
		return ef_eq
