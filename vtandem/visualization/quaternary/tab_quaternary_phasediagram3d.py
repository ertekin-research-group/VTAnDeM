...
class Tab_PhaseDiagram3D(QWidget):
	...
	def __init__(self, parent = None, main_compound = None, first_element = None, second_element = None, third_element = None, fourth_element = None, compounds_info = None):	# User specifies the main compound and its constituents
		...
		self.phasediagram3d_widget_layout.addWidget(self.quaternary_compound_title)				# Add the widget to the "main" widget grid layout
		...
		self.quaternary_phase_diagram_plot_3d = self.PhaseDiagram3D.quaternary_phasediagram_3d_plot_canvas
		self.phasediagram3d_widget_layout.addWidget(self.quaternary_phase_diagram_plot_3d)
		...
		self.first_element_selection_box.addItem(self.fourth_element)
		...
		self.second_element_selection_box.addItem(self.fourth_element)
		...
		self.third_element_selection_box.addItem(self.fourth_element)
		...
		self.fourth_element_selection_box.activated.connect(lambda: self.Update_Species(4))# When the user selects a species to be the fourth species, update the species list internally
		...
		self.generate_quaternary_phasediagram3d_button_widget.clicked[bool].connect(self.Generate_PhaseDiagram3D_Function)
		self.phasediagram3d_widget_layout.addWidget(self.generate_quaternary_phasediagram3d_button_widget)
		...
		self.quaternary_phase_diagram_plot_2d_tripleview = self.PhaseDiagram2D_TripleView.quaternary_phase_diagram_plot_canvas
		
		self.tab2_layout.addWidget(self.quaternary_phase_diagram_plot_2d_tripleview)
